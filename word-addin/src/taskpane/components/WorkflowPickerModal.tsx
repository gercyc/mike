...
export default function WorkflowPickerModal({ open, onClose, onSelect }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex flex-col bg-white">
      <div className="flex items-center justify-between border-b border-gray-200 px-3 py-2 shrink-0">
        <h2 className="font-serif text-sm text-gray-800">Pick a workflow</h2>
        <button
          onClick={onClose}
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <div className="p-4 text-xs text-gray-400">
            {query ? "No matches." : "No assistant workflows yet."}
          </div>
        ) : (
