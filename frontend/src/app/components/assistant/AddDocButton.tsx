            ...
            <DropdownMenu onOpenChange={setIsOpen}>
                <DropdownMenuTrigger asChild>
                    <button
                        ...
                        title={t("addDocButton.addDocuments")}
                        aria-label={t("addDocButton.addDocuments")}
                    >
                        {selectedDocIds.length > 0 ? (
                        ...
                        <span className="hidden sm:inline">
                            {selectedDocIds.length === 1
                                ? t("addDocButton.document")
                                : t("addDocButton.documents")}
                        </span>
                    </button>
                </DropdownMenuTrigger>
                <DropdownMenuContent
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-sm">
                            {uploading ? t("addDocButton.uploading") : t("addDocButton.uploadFiles")}
                        </span>
                    </DropdownMenuItem>
                    <DropdownMenuItem
                        className="cursor-pointer"
                    ...
                    >
                        ...
                        <span className="text-sm">{t("addDocButton.browseAll")}</span>
                    </DropdownMenuItem>
                </DropdownMenuContent>
            </DropdownMenu>
        </>
