    ...
    return (
        <>
                ...
                <div className="border border-gray-300 rounded-[16px] md:rounded-[20px] bg-white">
                    ...
                    <div className="px-4 pt-4">
                        <textarea
                            ref={textareaRef}
                            rows={1}
                            placeholder={t("chatInput.askPlaceholder")}
                            value={value}
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            {!hideWorkflowButton && (
                                <button
                                    ...
                                    aria-label={t("chatInput.openWorkflows")}
                            ...
                            {onProjectsClick && (
                                <button
                                    ...
                                    aria-label={t("chatInput.openProjects")}
            ...
            <AddDocumentsModal
                ...
                breadcrumb={[tc("nav.assistant"), t("addDocButton.addDocuments")]}
            />
