...
export function ProjectsOverview() {
    ...
    async function handleDeleteSelected() {
        ...
        if (blocked > 0) {
            setOwnerOnlyAction(
                t("ownerOnly.deleteSelectedProjects", { blocked }),
            );
        }
    }
        ...
        <div className="flex-1 overflow-y-auto bg-white">
            ...
            <div className="w-full overflow-x-auto">
                ...
                <div className="flex items-center h-8 pr-3 md:pr-10 border-b border-gray-200 text-xs text-gray-500 font-medium select-none">
                    ...
                    <div className="ml-auto w-32 shrink-0 text-left">{t("tableHeaders.cm")}</div>
                    <div className="w-24 shrink-0 text-left">{t("tableHeaders.files")}</div>
                    <div className="w-24 shrink-0 text-left">{t("tableHeaders.chats")}</div>
                    <div className="w-36 shrink-0 text-left">
                        {t("tableHeaders.reviews")}
                    </div>
